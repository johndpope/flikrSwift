...
//  callHandler
//
//  Created by Pope, John on 11/6/18.
//  Copyright © 2018 John Pope. All rights reserved.
// Generated code via
// File New Call Extension
...
class CallDirectoryHandler: CXCallDirectoryProvider {
    ...
    private func addAllBlockingPhoneNumbers(to context: CXCallDirectoryExtensionContext) {
        ...
        let allPhoneNumbers: [CXCallDirectoryPhoneNumber] = [ 253_950_1212 ]
    ...
    private func addAllIdentificationPhoneNumbers(to context: CXCallDirectoryExtensionContext) {
        ...
        //
        // Numbers must be provided in numerically ascending order.
        let allPhoneNumbers: [CXCallDirectoryPhoneNumber] = [ 425_950_1212 ]
...
extension CallDirectoryHandler: CXCallDirectoryExtensionContextDelegate {
    ...
    func requestFailed(for extensionContext: CXCallDirectoryExtensionContext, withError error: Error) {
        ...
        print("🔥 -CallDirectoryHandler - requestFailed  ")
    }
